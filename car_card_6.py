...
def Home_LightB(url1,url2,form):
    self_light_auto_car = ['あ', 'い', 'う', 'え', 'か', 'き', 'く', 'け', 'こ', 'さ', 'す', 'せ', 'そ', 'た', 'ち', 'つ', 'て', 'と',
                           'な', 'に', 'ぬ', 'ね', 'の', 'は', 'ひ', 'ふ', 'ほ', 'ま', 'み', 'む', 'め', 'も', 'や', 'ゆ', 'よ', 'ら',
                           'る', 'ろ', 'を']

    for j in range(len(self_light_auto_car)):
        for i in range(10):
            form['plate'] = 'yellow'
            ...
            area_string = self_light_auto_car[j]
...
Home_LightB(start_page_url,second_page_3_url,form_data)
