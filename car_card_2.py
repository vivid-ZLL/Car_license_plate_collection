...
def Home_B(url1,url2,form):
    self_auto_car = ['さ', 'す', 'せ', 'そ', 'た', 'ち', 'つ', 'て', 'と', 'な', 'に', 'ぬ', 'ね', 'の', 'は', 'ひ', 'ふ', 'ほ', 'ま', 'み','む', 'め', 'も', 'や', 'ゆ', 'ら', 'り', 'る', 'ろ']

    for j in range(len(self_auto_car)):
        for i in range(10):
            form['plate'] = 'white'
            ...
            with open(filename,'wb') as f:
                f.write(pdf_data)
            print 'file save successed!'

Home_B(start_page_url,second_page_1_url,form_data)
