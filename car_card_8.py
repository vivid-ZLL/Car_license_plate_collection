...
def Career_LightB(url1,url2,form):
    career_light_auto_car = ['り', 'れ']

    for j in range(len(career_light_auto_car)):
        for i in range(10):
            form['plate'] = 'black'
            ...
            area_string = career_light_auto_car[j]
...
Career_LightB(start_page_url,second_page_4_url,form_data)
